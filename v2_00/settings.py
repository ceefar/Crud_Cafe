...
# -- Misc Game Functions --
def move_to_true_pos(a_rect:pg.Rect, game):
    """ moves the position of anything inside the computer screen, by the computer screen """
    a_rect.move_ip(game.pc_screen_surf_x, game.pc_screen_surf_true_y + game.tab_bar_height) 
    # return a_rect
